...
public class GestiuneStudenti {
    ...
    public static void main(String[] args) {
        ...
        listaInitiala.add(new Student(101, "Andrei", "Popa", "OLD_GP", 0.0f));
        listaInitiala.add(new Student(102, "Maria", "Ionescu", "OLD_GP", 0.0f));
        listaInitiala.add(new Student(103, "Dan", "Georgescu", "OLD_GP", 0.0f));
        listaInitiala.add(new Student(104, "Ana", "Vasile", "OLD_GP", 0.0f));
        listaInitiala.add(new Student(105, "Ion", "Mihalcea", "OLD_GP", 0.0f));
        ...
        System.out.println("\n=== Grupa ISM2 (" + grupaB.size() + " studenti) ===");
